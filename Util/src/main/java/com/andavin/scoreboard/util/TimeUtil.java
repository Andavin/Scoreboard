...
public final class TimeUtil {
    ...
    public static long getBeginningDay() {
        final Calendar calendar = Calendar.getInstance(EST);
     ...
     */
    public static long parse(final String timeString) throws NumberFormatException {

        long total = 0;
        final Matcher matcher = TIME_PATTERN.matcher(timeString);
        while (matcher.find()) {

            final String main = matcher.group();
